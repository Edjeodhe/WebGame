...
// 개미 — 근거리 전사: 금빛 왕관 + 붉은 망토 + 긴 창, 가장 육중한 실루엣
// (레퍼런스: 왕관을 쓴 검은 갑옷의 개미 군주, 붉은 망토, 한 손에 장창)
const ANT_WARRIOR = {
  palette: {
    B: '#4a3423', // 갑옷 몸통(짙은 갈색)
    C: '#2f2015', // 투구(더 어두운 갑각)
    E: '#ffca28', // 바이저 눈빛
    W: '#d7dde0', // 창 금속
    H: '#7a5636', // 갑옷 하이라이트
    K: '#1a1009', // 윤곽/다리
  ...
  blocks: [
    r(3, -3, 1, 1, 'A'), r(6, -3, 1, 1, 'A'), // 더듬이 끝
    r(3, -2, 1, 1, 'A'), r(6, -2, 1, 1, 'A'),
    r(3, -2, 1, 1, 'G'), r(5, -2, 1, 1, 'G'), r(7, -2, 1, 1, 'G'), // 왕관 뾰족한 끝
    r(3, -1, 5, 1, 'G'), // 왕관 띠
    r(3, 0, 4, 3, 'C'), // 투구
    r(3, 1, 1, 1, 'E'), r(6, 1, 1, 1, 'E'), // 바이저 눈
    r(0, 3, 2, 8, 'R'), // 붉은 망토(뒤로 흐름)
    r(2, 3, 6, 1, 'H'), // 어깨 갑옷
    r(2, 4, 6, 6, 'B'), // 두꺼운 몸통 갑옷
    r(3, 5, 4, 2, 'H'), // 흉갑 문양
    r(2, 10, 2, 4, 'K'), r(6, 10, 2, 4, 'K'), // 굵은 다리
    r(9, -4, 1, 3, 'W', true), r(8, -2, 2, 1, 'W', true), // 뾰족한 창날
    r(9, -1, 1, 12, 'W', true), // 긴 창대
  ],
};

// 장수풍뎅이 — 원거리 궁수: 위로 뻗은 큰 뿔 + 파란 망토 + 빛나는 활
// (레퍼런스: 파란 두건/망토를 두른 갑각 궁수, 청록빛으로 빛나는 활과 화살)
const BEETLE_ARCHER = {
  palette: {
    B: '#1a3a5c', // 파란 갑옷 몸통
    C: '#0f2438', // 갑각 머리
    ...
    H: '#2e5f8a', // 갑옷 하이라이트
    K: '#081521', // 윤곽/다리
    L: '#4fc3f7', // 빛나는 활/화살(청록)
    P: '#3949ab', // 파란 망토
  },
  blocks: [
    r(4, -4, 2, 1, 'W'), r(4, -3, 1, 2, 'W'), r(5, -3, 2, 1, 'W'), r(6, -4, 1, 2, 'W'), // 위로 휜 큰 뿔
    r(2, 0, 6, 3, 'C'), // 갑각 머리(두건)
    r(3, 1, 1, 1, 'E'), r(6, 1, 1, 1, 'E'),
    r(0, 3, 2, 8, 'P'), // 파란 망토
    r(2, 3, 6, 1, 'H'),
    r(2, 4, 6, 5, 'B'), // 넓은 몸통
    r(3, 5, 4, 2, 'H'),
    r(2, 9, 2, 5, 'K'), r(6, 9, 2, 5, 'K'), // 다리
    r(8, 0, 1, 3, 'L', true), r(9, 3, 1, 3, 'L', true), r(8, 6, 1, 3, 'L', true), // 빛나는 활대(곡선)
    r(5, 4, 4, 1, 'L', true), // 시위에 걸린 화살
  ],
};

// 나비 — 원거리 마법사: 뾰족한 마녀 모자 + 분홍/보라 나비 날개 + 지팡이
// (레퍼런스: 마녀 모자를 쓴 마법사, 좌우로 큰 나비 날개, 끝에 빛나는 나비가 달린 지팡이)
const BUTTERFLY_MAGE = {
  palette: {
    ...
    K: '#2e0845', // 윤곽/더듬이
    P: '#ab47bc', // 나비 날개(보라)
    G: '#f06292', // 나비 날개 무늬(분홍)
  },
  blocks: [
    r(6, -5, 2, 1, 'C'), r(5, -4, 2, 1, 'C'), r(4, -3, 2, 1, 'C'), // 휘어진 모자 끝
    r(2, -2, 6, 2, 'C'), // 모자 몸체
    r(1, 0, 8, 1, 'H'), // 모자 챙
    r(3, 1, 4, 2, 'C'), // 얼굴 그늘(후드)
    r(3, 2, 1, 1, 'E'), r(6, 2, 1, 1, 'E'),
    r(-2, 3, 3, 3, 'P'), r(9, 3, 3, 3, 'P'), // 위쪽 큰 날개
    r(-1, 3, 1, 2, 'G'), r(10, 3, 1, 2, 'G'), // 날개 무늬(분홍)
    r(-1, 6, 3, 2, 'P'), r(8, 6, 3, 2, 'P'), // 아래쪽 작은 날개
    r(3, 3, 4, 6, 'B'), // 로브
    r(3, 9, 4, 4, 'B'), // 로브 자락
    r(8, -1, 1, 11, 'W', true), // 지팡이
    r(7, -3, 3, 2, 'G', true), r(8, -4, 1, 1, 'W', true), // 지팡이 끝 빛나는 나비/보석
  ],
};

// 잠자리 — 근거리 도적: 녹색 후드 + 옆으로 길게 뻗은 투명 잠자리 날개 + 쌍단검
// (레퍼런스: 녹색 후드를 뒤집어쓴 날렵한 도적, 반투명 녹색 날개 4장, 빛나는 단검)
const DRAGONFLY_ROGUE = {
  palette: {
    B: '#2e5e3e', // 녹색 몸통
    C: '#1b3a26', // 후드
    E: '#b2ff59', // 빛나는 눈
    W: '#dff5e1', // 단검 날(연녹빛 광택)
    H: '#43a047', // 벨트/하이라이트
    K: '#0d1f14', // 윤곽/다리
    N: '#a5d6a7', // 반투명 잠자리 날개
  },
  blocks: [
    r(3, -1, 4, 2, 'C'), // 후드 끝(뾰족)
    r(2, 1, 6, 3, 'C'), // 후드 머리
    r(3, 2, 1, 1, 'E'), r(6, 2, 1, 1, 'E'), // 빛나는 눈
    r(-4, 2, 5, 1, 'N'), r(9, 2, 5, 1, 'N'), // 위쪽 긴 날개
    r(-3, 4, 5, 1, 'N'), r(8, 4, 5, 1, 'N'), // 아래쪽 긴 날개
    r(3, 4, 4, 5, 'B'), // 날렵한 몸통
    r(3, 6, 4, 1, 'H'), // 벨트
    r(2, 9, 2, 4, 'K'), r(6, 9, 2, 4, 'K'), // 다리
    r(1, 4, 1, 5, 'W', true), r(8, 4, 1, 5, 'W', true), // 쌍단검
  ],
};
